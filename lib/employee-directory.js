...
export async function upsertEmployeeDirectoryEntry({ code, name, email, department, commuteMiles = 0, commissionPlan = "", shirtSize = null, shoeSize = null }, actorUserId = null) {
  ...
  const result = await pool.query(
    `INSERT INTO employee_directory (code, name, email, department, commute_miles, commission_plan, job_title_code, department_code, shirt_size, shoe_size, updated_at, updated_by)
     VALUES ($1, $2, $3, $4, $5, $6, $7, $8, COALESCE($10, ''), COALESCE($11, ''), NOW(), $9)
