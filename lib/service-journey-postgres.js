...
export const DEFAULT_SETTINGS = {
  ...
  // Who gets the "warranty ticket approved for parts — set SO3 in ePASS"
  // flag + email (the estimate-approvals queue). Edit with
  //   POST /api/service-journey/settings {"key":"notify.warranty_so3.emails","value":["..."]}
  "notify.warranty_so3.emails": ["ncautrell@wilsonappliance.com"],
...
// (warranty SO3 → Noell's notification queue, 9/22 late). Never fires for
