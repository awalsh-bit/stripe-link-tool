...
export async function saveShopInventorySnapshot({ serials, types, written, units, sourceFile, uploadedBy }) {
  ...
  return { count: clean.length, typedCount: Object.keys(cleanTypes).length, writtenCount: Object.keys(cleanWritten).length, unitDetailCount: cleanUnits.length, historyCount };
}
