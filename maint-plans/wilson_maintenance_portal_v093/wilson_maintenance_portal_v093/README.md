...
# Wilson Maintenance Portal Prototype v0.3
...
```text
cd wilson_maintenance_portal_v03
./start_demo.sh
```

## v0.3 customer enrollment

`appliance-signup.html` now uses twelve broad customer-facing categories:
...
- `quote-builder.html` / `quote-view.html` — estate proposal workflow
...
Screenshots from the targeted render checks are included in `screenshots_v03/`.
